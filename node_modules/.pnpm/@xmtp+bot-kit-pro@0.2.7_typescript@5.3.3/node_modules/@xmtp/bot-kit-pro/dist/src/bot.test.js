...
import Bot, { getOrCreateXmtpKeys } from "./bot.js";
...
describe("Bot", () => {
    ...
    const getConfig = (handler) => {
        ...
        return newBotConfig(randomBytes(32).toString("hex"), {
            xmtpKeys: keys,
            xmtpEnv: "dev",
        }, botHandler);
    };
    ...
    it("can save a message", async () => {
        ...
        const convo = await bot.client.conversations.newConversation(otherClient.address);
    ...
    it("can handle messages", async () => {
        ...
        await sleep(100);
        const convo = await otherClient.conversations.newConversation(bot.client.address);
